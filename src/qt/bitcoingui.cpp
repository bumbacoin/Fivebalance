...
{
    resize(900, 520);
    setWindowTitle(tr("Fivebalance") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("fivebalance");
    setStyleSheet("#fivebalance { background-color:#ffffff;  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    if (!fUseBlackTheme)
    {
        ...
        {
            progressBar->setStyleSheet("QProgressBar { color: #ffffff;background-color: #ffffff; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #FF8000, stop: 1 orange); border-radius: 7px; margin: 0px; }");
        }
    }
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Fivebalance address"));
    ...
    aboutAction = new QAction(tr("&About Fivebalance"), this);
    aboutAction->setToolTip(tr("Show information about Fivebalance"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Fivebalance"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-weight:bold; margin-top: 1px; margin-bottom: 1px;} QToolButton:hover { color: #ffffff; background-color: #00011f;} QToolButton:checked { background-color: #333333; } QToolButton:pressed { background-color: #333333; } #tabs { color: #ffffff; background-color: #00011f;}");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Fivebalance client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Fivebalance client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fivebalance network", "", count));
}
...
{
    QString strTitle = tr("Fivebalance") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Fivebalance address or malformed URI parameters."));
    }
