...
Value checkkernel(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "Fivebalance is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "Fivebalance is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Fivebalance is downloading blocks...");
