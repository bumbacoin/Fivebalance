...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeFivebalance = new QSpinBox(tabMain);
        anonymizeFivebalance->setObjectName(QStringLiteral("anonymizeFivebalance"));
        anonymizeFivebalance->setMinimum(2);
        anonymizeFivebalance->setMaximum(10000);
        anonymizeFivebalance->setSingleStep(10);
        anonymizeFivebalance->setValue(1000);

        gridLayout->addWidget(anonymizeFivebalance, 7, 1, 1, 1);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Fivebalance after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Fivebalance on system login", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Fivebalance to keep anonymized", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Fivebalance client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Fivebalance network through a SOCKS5 proxy (e.g. when connecting through Tor).", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Fivebalance.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
