...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 FBN"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 FBN"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 FBN"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 FBN"));
